...
namespace KHOD
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.fluentDesignFormContainer1.Location = new System.Drawing.Point(293, 39);
			this.fluentDesignFormContainer1.Name = "fluentDesignFormContainer1";
			this.fluentDesignFormContainer1.Size = new System.Drawing.Size(810, 466);
			...
			this.panelMain.Size = new System.Drawing.Size(810, 466);
			...
			this.accordionControl1.Size = new System.Drawing.Size(293, 466);
			...
			this.accordionControlElement23.Text = "THỰC ĐƠN";
			// 
			...
			this.accordionControlElement22.Text = "Danh sách thực đơn";
			...
			this.accordionControlElement24.Text = "Danh sách nguyên liệu theo ngày";
			// 
			...
			this.accordionControlElement1.Text = "Kiểm tra kho";
			...
			this.accordionControlElement7.Text = "Thống kê nguyên liệu";
			...
			this.accordionControlElement8.Text = "Đặt nguyên liệu";
			// 
			...
			this.accordionControlElement19.Text = "Nhập kho";
			...
			this.accordionControlElement20.Text = "Hóa đơn";
			...
			this.accordionControlElement18.Text = "Xuất kho";
			// 
			...
			this.accordionControlElement6.Text = "QUẢN LÝ NHÂN SỰ";
			...
			this.accordionControlElement16.Text = "Quản lý người dùng";
			// 
			...
			this.accordionControlElement17.Text = "Thêm người dùng";
			// 
			...
			this.accordionControlElement9.Text = "SAO LƯU PHỤC HỒI";
			// 
			...
			this.accordionControlElement14.Text = "Sao lưu dữ liệu";
			...
			this.accordionControlElement15.Text = "Phục hồi dữ liệu";
			...
			this.accordionControlElement11.Text = "Thay đổi mật khẩu";
			...
			this.accordionControlElement12.Text = "Thông tin người dùng";
			...
			this.accordionControlElement13.Text = "Thoát";
			// 
			...
			this.fluentDesignFormControl1.Size = new System.Drawing.Size(1103, 39);
			...
			this.barEditItem1.ImageOptions.Image = global::KHOD.Properties.Resources._2;
			...
			this.Text = "QUẢN LÝ KHO NGUYÊN LIỆU CẤP TIỂU ĐOÀN";
